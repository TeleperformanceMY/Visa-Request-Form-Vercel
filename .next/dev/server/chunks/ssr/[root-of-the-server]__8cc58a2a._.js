...
const metadata = {
    ...
    description: "Discover which countries you can travel visa-free, with visa on arrival, or where you need a visa based on your nationality. Dynamic, real-time visa requirements database.",
    generator: "v0.app",
    icons: {
        icon: [
            {
